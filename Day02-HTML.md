...
# web-page-example
В этом репозитории находится пример интернет-страницы, который можно использовать для представления вашей личной информации, проекта, курсовой работы и т. д.  
