...
3. **Инструкция по работе с корпусом**  
     ...
     * На страницах <a href="http://ruscorpora.ru/corpora-morph.html">Морфология</a>, <a href="http://ruscorpora.ru/corpora-sem.html"Семантика</a> и др. (в меню главной страницы корпуса) можно узнать расшифровку корпусных помет
...
<a href="url"><img src="https://github.com/olesar/olesar.github.io/blob/master/KILI/img/Gihub_EditFile.png" width="300" ></a><br /> 
...
В поле 3.1 ниже впишите количество вхождений слов, начинающихся на _цы-_, но не _цыган, цыпочки, цыпленок, цыц_
```
# 3.1 Ответ: 
```

### Настройки сортировки: по дате создания, по правому контексту. Формат выдачи KWIQ.  
<img src="https://olesar.github.io/KILI/img/RNC_Sort1.png" width="300" />
Укажите год создания самого раннего текста Основного корпуса, включающего слова из запроса 3.1, а также лемму первого по времени вхождения. 
```
# 3.2 Первое вхождение (год): 
# 3.3 Первое вхождение (лемма): 
```
Мы уже предлагали поискать словосочетание `баба с возу` с помощью точного поиска. Почему строка `баба с возу` (набранная вместе в поле Слово лексико-грам. поиска) не будет найдена в корпусе?
```
# 3.4 Ответ: 
```
...
Сколько уникальных лемм имеют счетную форму?
```
